            ...
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        ...
                        <form action="{{route('personAllDetails')}}" class="frm-single" method="POST"  autocomplete="off">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between ">
                                <a  href="{{route('loginMobilePage')}}" class="propelbtn propelbtncurved propellogin propel-hover">Cancel</a>
