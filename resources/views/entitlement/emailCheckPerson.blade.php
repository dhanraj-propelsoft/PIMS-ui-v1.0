            ...
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        ...
                        <p class="black " class="top-info">
                            No credentials are found, with your mobile number {{$mobileNumber}}, Kindly provide email for cross verification
                        </p>
                        <form action="{{url('checkPersonEmail')}}" class="frm-single" method="post" autocomplete="off">
                            @csrf
                            <label class="form-group col-md-12  p-0 mb-4" style="position: relative;">
                                ...
                                <input type="hidden" name="personUid" value="{{$personUid}}">
                        ...
                        <p class="ExtraInfo">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Kindly provide your personal and permeant email only never enter anyofficial email which may be invalid on time.
                          </p>
