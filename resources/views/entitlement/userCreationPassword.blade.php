            ...
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        ...
                        <form action="{{route('storeUser')}}" class="frm-single" method="post" autocomplete="off">
                            @csrf
                            ...
                            <fieldset class="fieldset-password">
                                ...
                                <label class="form-group col-md-12 p-0  InputLabel mb-4">
                                    <input class="form-control AlterInput" id="input-password" type="password" placeholder="Enter New Password" name="password" value="{{ old('password') }}" />
                                    <span class="text-danger">@error('password'){{ $message }}@enderror</span>
                                    <span class="AlterInputLabel">Password</span>
                                </label>

                                <label class="form-group col-md-12 p-0  InputLabel mb-4">
                                    <input class="form-control AlterInput" id="input-password1" type="password" placeholder="Retype Password for Confirmation" name="passwordConfirmation" value="{{ old('confirm_password') }}" />
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <button class="propelbtn propelbtncurved propellogin sign_up" type="submit">Sign up</button>
                            </div>
                        </form>
