            ...
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        ...
                        <form action="{{route('findCredential')}}" class="frm-single" method="post" autocomplete="off">
                            @csrf
                            <label class="form-group col-md-12 p-0  InputLabel mb-4">
                                <input class="form-control AlterInput" type="text" placeholder="Mobile" name="mobileNumber" value="{{$mobile}}" readonly/>
