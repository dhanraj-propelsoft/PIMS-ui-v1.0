            ...
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        ...
                        <form action="{{route('personConfirmationPage')}}" class="frm-single" method="post" autocomplete="off">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between ">
                                <a href="{{route('loginMobilePage')}}" class="propelbtn propelbtncurved propellogin propel-hover" type="button">Cancel</a>
                                <button class="propelbtn propelbtncurved propellogin propel-hover" type="submit">Continue</button>
                            </div>
                        </form>
