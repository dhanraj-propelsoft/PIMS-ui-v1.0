...
@section('content')
    ...
    <!-- | -->
    <div class="organisation0 businessSaleSubsets0 add0 for-active"><!-- | -->
        <!-- | -->
        <div class="add"> <!-- | -->
            <!-- | --> <span>add</span> <!-- | -->
            <!-- | -->
    ...
    <form action="{{ route('businessSaleSubset.store') }}" data-dupl-val="true" method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="businessSaleSubset" required placeholder="Business Sale Subsets..."
    ...
    <script>
        ...
        var valRouteUrl = "{{ route('businessSaleSubsetValidation') }}";
    </script>
@endsection
