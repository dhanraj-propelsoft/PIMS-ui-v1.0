...
@section('content')
    ...
    <!-- | -->
    <div class="organisation0 businessSaleSubsets0 view0 for-active"><!-- | -->
        <!-- | -->
        <div class="view"> <!-- | -->
            <!-- | --> <span>view</span> <!-- | -->
            <!-- | -->
    ...
    <div class="m-auto col-md-6 card p-2 rounded">
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="businessSaleSubsets" placeholder="Business Sale Subsets..."
                class="form-control AlterInput " autocomplete="off" disabled value="{{ $modeldata['businessSaleSubset'] }}">
        ...
        <div class="row justify-content-between  mx-1  mt-3">
            ...
            <button class="propelbtn propelbtncurved propelsubmit" onclick="viewPage(<?php echo $modeldata['businessSaleSubsetId']; ?>)">Edit</button>
        </div>
