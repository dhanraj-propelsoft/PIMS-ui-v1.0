...
@section('content')
    ...
    <div class="m-auto col-md-6 card p-2 rounded">
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="category" placeholder="Category..." class="form-control AlterInput " autocomplete="off"
                disabled value="{{ $modeldata['category'] }}">
        ...
        <div class="row justify-content-between  mx-1  mt-3">
            ...
            <button class="propelbtn propelbtncurved propelsubmit" onclick="viewPage(<?php echo $modeldata['categoryId']; ?>)">Edit</button>
        </div>
