...
@section('content')
    ...
    <div class="m-auto col-md-6 card p-2 rounded">
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="businessActivities" placeholder="Business Activities..."
                class="form-control AlterInput " autocomplete="off" disabled value="{{ $modeldata['businessActivity'] }}">
        ...
        <div class="row justify-content-between  mx-1  mt-3">
            ...
            <button class="propelbtn propelbtncurved propelsubmit" onclick="viewPage(<?php echo $modeldata['businessActivityId']; ?>)">Edit</button>
        </div>
