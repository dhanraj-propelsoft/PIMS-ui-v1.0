...
@section('content')
    ...
    <!-- | -->
    <div class="organisation0 businessSector0 edit0 for-active">
        <!-- | -->
        <!-- | -->
        <div class="edit">
            <!-- | -->
    ...
    <form action="{{ route('businessSector.store') }}" data-dupl-val="true" data-edit-form="true" method="post"
        class="m-auto col-md-6 card p-2 rounded">
        @csrf
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="businessSector" placeholder="Business Sector..."
                class="form-control AlterInput  propel-key-press-input-mendatory" autocomplete="off"
                value="{{ $modeldata['businessSector'] }}">
        ...
        <input type="hidden" value="{{ $modeldata['businessSectorId'] }}" name="id">
    ...
    <form action="{{ route('businessSector.destroy', $modeldata['businessSectorId']) }}" method="POST">
        @csrf
        @method('DELETE')
    ...
    <script>
        ...
        var valRouteUrl = "{{ route('businessSectorValidation') }}";
