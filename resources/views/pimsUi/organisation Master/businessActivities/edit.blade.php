...
@section('content')
    ...
    <!-- | -->
    <div class="common-master0 businessActivities0 edit0 for-active">
        <!-- | -->
        <!-- | -->
        <div class="edit">
            <!-- | -->
    ...
    <form action="" method="post" class="m-auto col-md-6 card p-2 rounded">
        ...
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="businessActivities" placeholder="Person Business Activities..." class="form-control AlterInput "
