...
<!-- | -->
<div class="common-master0 businessSaleSubsets0 add0 for-active"><!-- | -->
  <!-- | -->
  <div class="add"> <!-- | -->
    <!-- | --> <span>add</span> <!-- | -->
    <!-- | -->
...
<form action="" method="post" class="m-auto col-md-6 card p-2 rounded">
  ...
  <label class="form-group p-0 mb-4 InputLabel w-100">
    <input type="text" name="businessSaleSubsets" required  placeholder="Person Business Sale Subsets..." class="form-control AlterInput " autocomplete="off">
