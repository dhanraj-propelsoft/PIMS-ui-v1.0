...
{{-- This is For Navigation and Breadcrumbs --}}
 ...
 <div class="m-auto col-md-6 card p-2 rounded">
    <label class="form-group p-0 mb-4 InputLabel w-100">
        <input type="text" name="organizationDocumentType" placeholder="Person Organization Document Type..." class="form-control AlterInput " autocomplete="off" disabled value="">
