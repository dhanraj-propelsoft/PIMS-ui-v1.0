...
@section('content')
    ...
    <!-- | -->
    <div class="person-master0 personDocumentType0 add0 for-active"><!-- | -->
        <!-- | -->
        <div class="add"> <!-- | -->
            <!-- | --> <span>add</span> <!-- | -->
            <!-- | -->
    ...
    <form action="{{ url('documentType') }}" data-dupl-val="true" method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="documentType" required placeholder="Document Type..."
    ...
    <script>
        ...
        var valRouteUrl = "{{ route('documentTypeValidation') }}";
    </script>
@endsection
