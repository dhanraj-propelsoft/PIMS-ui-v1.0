...
@section('content')
    ...
    <form action="{{ route('language.store') }}" data-edit-form="true" class="m-auto col-md-6 card p-2 rounded">
        @csrf
    ...
    <form action="{{ route('language.destroy', $modeldata['id']) }}" method="POST">
        @csrf
        @method('DELETE')
