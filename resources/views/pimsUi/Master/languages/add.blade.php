...
@section('content')
    ...
    <!-- | -->
    <div class="common-master0 language0 add0 for-active"><!-- | -->
        <!-- | -->
        <div class="add"> <!-- | -->
            <!-- | --> <span>add</span> <!-- | -->
            <!-- | -->
    ...
    <form action="{{ route('language.store') }}" data-dupl-val="true" method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
    ...
    <script>
        ...
        var valRouteUrl = "{{ route('languageValidation') }}";
    </script>
@endsection
