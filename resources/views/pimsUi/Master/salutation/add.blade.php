...
@section('content')
    ...
    <!-- | -->
    <div class="person-master0 salutation0 add0 for-active"><!-- | -->
        <!-- | -->
        <div class="add"> <!-- | -->
            <!-- | --> <span>add</span> <!-- | -->
            <!-- | -->
    ...
    <form action="{{ url('salutation') }}" data-dupl-val="true" method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="salutation" required placeholder="Salutation..."
    ...
    <script>
        ...
        duplVal.on('input change', function() {
            ...
            $.ajax({
                url: "{{ route('salutationValidation') }}",
                type: 'ajax',
                method: 'post',
                data: formData,
                contentType: false,
