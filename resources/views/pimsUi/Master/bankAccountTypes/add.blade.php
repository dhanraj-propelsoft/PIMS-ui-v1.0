...
@section('content')
    ...
    <!-- | -->
    <div class="common-master0 bankAccountTypes0 add0 for-active"><!-- | -->
        <!-- | -->
        <div class="add"> <!-- | -->
            <!-- | --> <span>add</span> <!-- | -->
            <!-- | -->
    ...
    <form action="{{ route('bankAccountType.store') }}" data-dupl-val='true' method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="bankAccountType" required placeholder="Bank Account Types..."
    ...
    <script>
        ...
        duplVal.on('input change', function() {
            ...
            $.ajax({
                url: "{{ route('bankAccountTypeValidation') }}",
                type: 'ajax',
                method: 'post',
                data: formData,
                contentType: false,
