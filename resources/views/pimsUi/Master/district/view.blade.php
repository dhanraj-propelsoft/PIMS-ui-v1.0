...
{{-- This is For Navigation and Breadcrumbs --}}
 ...
 <div class="m-auto col-md-6 card p-2 rounded">
  <label class="form-group p-0 InputLabel w-100">
    <select disabled class="form-select w-100 AlterInput search-need" name="stateId" data-minimum-results-for-search="Infinity"
    ...
    <label class="form-group p-0 mb-4 InputLabel w-100">
        <input type="text" name="district" placeholder="Enter District..." class="form-control AlterInput " autocomplete="off" disabled value="{{ $modeldata['district'] }}">
