...
<!-- | -->
<div class="person-master0 qualification0 add0 for-active"><!-- | -->
  <!-- | -->
  <div class="add"> <!-- | -->
    <!-- | --> <span>add</span> <!-- | -->
    <!-- | -->
...
<form action="{{route('qualification.store')}}" method="post" class="m-auto col-md-6 card p-2 rounded">
  ...
  <label class="form-group p-0 mb-4 InputLabel w-100">
    <input type="text" name="qualification" required  placeholder="Enter Your Qualification..." class="form-control AlterInput " autocomplete="off">
