...
@section('content')
    ...
    <form action="{{ route('bloodGroup.store') }}" data-dupl-val='true' method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="bloodGroup" required placeholder="Blood Group..."
