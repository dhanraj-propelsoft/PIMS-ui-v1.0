...
<!-- | -->
<div class="person-master0 bloodGroup0 add0 for-active"><!-- | -->
  <!-- | -->
  <div class="add"> <!-- | -->
    <!-- | --> <span>add</span> <!-- | -->
    <!-- | -->
...
<form action="{{route('bloodGroup.store')}}" method="post" class="m-auto col-md-6 card p-2 rounded">
  @csrf
  <label class="form-group p-0 mb-4 InputLabel w-100">
    <input type="text" name="bloodGroup" required  placeholder="Blood Group..." class="form-control AlterInput" autocomplete="off">
