...
<!-- | -->
<div class="person-master0 relationShip0 add0 for-active"><!-- | -->
  <!-- | -->
  <div class="add"> <!-- | -->
    <!-- | --> <span>add</span> <!-- | -->
    <!-- | -->
...
<form action="{{route('relationShip.store')}}" method="post" class="m-auto col-md-6 card p-2 rounded">
  ...
  <label class="form-group p-0 mb-4 InputLabel w-100">
    <input type="text" name="relationShip" required  placeholder="Relationship..." class="form-control AlterInput" autocomplete="off">
