...
{{-- This is For Navigation and Breadcrumbs --}}
 ...
 <!-- | -->   <div class="pfm0 cachet0 view0 for-active"><!-- | -->
 <!-- | -->     <div class="view">                                    <!-- | -->
 <!-- | -->      <span>view</span>                                    <!-- | -->
 <!-- | -->    </div>                                                <!-- | -->
 <!-- | -->   </div>                                                 <!-- | -->
 ...
 <div class="m-auto col-md-6 card p-2 rounded">
    <label class="form-group p-0 mb-4 InputLabel w-100">
        <input type="text" name="cachet" placeholder="Enter Cachet..." class="form-control AlterInput " autocomplete="off" disabled value="{{ $modeldata['cachet'] }}">
