...
@section('content')
    ...
    <form action="{{route('authorization.store')}}" method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="authorization" placeholder="Enter Authorization..." class="form-control AlterInput "
                autocomplete="off" value="{{ $modeldata['authorization'] }}">
