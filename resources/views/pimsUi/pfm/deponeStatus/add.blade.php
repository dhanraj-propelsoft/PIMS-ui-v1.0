...
@section('content')
    ...
    <!-- | -->
    <div class="pfm0 deponeStatus0 add0 for-active"><!-- | -->
        <!-- | -->
        <div class="add"> <!-- | -->
            <!-- | --> <span>add</span> <!-- | -->
            <!-- | -->
    ...
    <form action="{{ route('deponeStatus.store') }}" data-dupl-val="true" method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="deponeStatus" required placeholder="Enter Depone Status..."
    ...
    <script>
        ...
        var valRouteUrl = "{{ route('deponeStatusValidation') }}";
    </script>
@endsection
