...
@section('content')
    ...
    <form action="{{ route('origin.store') }}" data-dupl-val="true" data-edit-form="true" method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
    ...
    <script>
        ...
        var valRouteUrl = "{{ route('originValidation') }}";
