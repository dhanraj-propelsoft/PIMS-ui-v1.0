...
@section('content')
    ...
    <!-- | -->
    <div class="pfm0 validation0 edit0 for-active">
        <!-- | -->
        <!-- | -->
        <div class="edit">
            <!-- | -->
    ...
    <form action="{{route('validation.store')}}" method="post" class="m-auto col-md-6 card p-2 rounded">
        @csrf
        <label class="form-group p-0 mb-4 InputLabel w-100">
            <input type="text" name="validation" placeholder="Enter Validation..." class="form-control AlterInput "
                autocomplete="off" value="{{ $modeldata['validation'] }}">
    ...
    <form action="{{ route('validation.destroy', $modeldata['id']) }}" method="POST">
        @csrf
        @method('DELETE')
