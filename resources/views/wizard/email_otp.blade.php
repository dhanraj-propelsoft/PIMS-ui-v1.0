                    ...
                    <div class="form-side">
                        ...
                        <form action="{{route('validate_otp')}}" class="frm-single" method="post" autocomplete="off">
                            ...
                            <label class="form-group col-md-12 p-0  InputLabel mb-4">
                                <input class="form-control AlterInput" placeholder="Enter OTP Received on your email" name="otp" value="{{ old('otp') }}" required />
                                <span class="text-danger">@error('otp'){{ $message }}@enderror</span>
                                <span class="AlterInputLabel">Enter OTP Received on your email {{$email}}</span>
                            </label>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if($error)
                                <a href="{{route('resend_email_otp',['uid'=>$uid])}}"><button class="propelbtn propelbtncurved propelreset" type="button">Resend OTP</button></a>
                                @endif
