                        ...
                        <form action="{{route('upload_pic')}}" class="frm-single" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="portlet light profile-sidebar-portlet bordered">
                                ...
                                <div class="profile-userbuttons d-flex justify-content-between align-items-center">
                                    <a href="{!! route('edit_profile', ['uid'=>$uid]) !!}"><button type="button" class="propelbtn propelbtncurved propelcancel">Skip Now</button></a>
                                    <button type="submit" class="propelbtn propelbtncurved propelupdate">Update</button>
                                </div>
                            </div>
