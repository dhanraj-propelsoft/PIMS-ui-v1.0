            ...
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    <div class="position-relative image-side ">
                        ...
                        <p class="white mb-0">
                            Enter OTP Received on your Mobile {{$mobile}}
                        </p> --}}
                    </div>
                    <div class="form-side">
                        ...
                        <form action="{{route('person_details_update')}}" class="frm-single" method="post" autocomplete="off">
                            ...
                            <input type="hidden" value="{{$mobile}}" id="number">
                            <input type="hidden" name="uid" id="uid" class="frm-inp" value="{{$uid}}">
                            <div class="frm-input" id="recaptcha-container"></div>

                            <div class="d-flex justify-content-between align-items-center">
                                <button class="propelbtn propelbtncurved propelreset" type="button" onclick="ResendOTP();">Resend OTP</button>
                                <button class="propelbtn propelbtncurved propellogin" type="button" onclick="verify();">Validate</button>
