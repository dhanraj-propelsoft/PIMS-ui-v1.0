                    ...
                    <div class="form-side">
                        ...
                        <form action="{{route('form_submit')}}" class="frm-single" method="post" autocomplete="off">
                            ...
                            <fieldset class="fieldset-password">
                                ...
                                <label class="form-group col-md-12 p-0  InputLabel mb-4">
                                    <input class="form-control AlterInput" id="input-password1" type="password" placeholder="Retype Password for Confirmation" name="password_confirmation" value="{{ old('confirm_password') }}" />
