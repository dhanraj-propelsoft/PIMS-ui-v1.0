...
<span>Propel Soft</span>
                            ...
                            <form action="{{ route('check') }}" id="mobile_form" class="frm-single" method="post" autocomplete="off">
                                @csrf
                                <div class="input-group mb-2 mr-sm-2" style="border-bottom:2px solid rgb(215,215,215);">
                                    ...
                                    <input type="text" class="form-control" id="inlineFormInputGroupUsername2"
                                        placeholder="India" style="text-align:center; outline:none; border:none;" readonly>
