            ...
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        ...
                        <h6 class="mb-4"></h6>
                        <br><br>
                        <form action="{{route('complete_profile')}}" id="form" class="frm-single" method="post" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <label class="form-group col-md-12 p-0  InputLabel mb-4">
                                <input class="form-control AlterInput name" type="text" placeholder="Name" name="name" value="{{$result[0]['first_name']}}" required />
                            ...
                            <label class="form-group col-md-12 p-0 d-flex justify-content-between InputLabel mb-4">
                                <input class="form-control AlterInput w-80 homeInput" type="text" placeholder="home address" name="home_address" value="{{ old('home_address') }}" required readonly />
                            ...
                            <label class="form-group col-md-12 p-0  InputLabel mb-4">
                                <input class="form-control AlterInput" type="text" placeholder="Family Name" name="family_name" value="{{$result[0]['first_name'].' '.'family'}}" />
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <button class="propelbtn propelbtncurved propelsave" onclick="validate_address();" type="button">Save</button>
                            </div>
                        </form>
