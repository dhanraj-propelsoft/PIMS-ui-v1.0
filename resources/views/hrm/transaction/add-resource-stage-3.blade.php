                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 d-flex align-items-center">
                                ...
                                <label class="form-group  p-0   InputLabel w-80 ">
                                    <input type="text" name="firstName" class="form-control AlterInput w-100 propel-key-press-input-mendatory" placeholder="First Name..." style="border-top-left-radius:0 !important; border-bottom-left-radius:0 !important;">
            ...
            <div id="customButtons3">
                <div class="form-row">
                    <div class="form-group col-md-2 ">
                        <label class="form-group  p-0   InputLabel w-100 m-1">
                            <input type="text" name="mobileNumber" class="form-control AlterInput w-100 " placeholder="primary Mobile..." readonly value="{{$mobileNo}}">
                ...
                <hr>
                    ...
                    <div class="form-group col-md-2 ">
                        <label class="form-group  p-0   InputLabel w-100 m-1">
                            ...
                            <input type="email" name="email" class="form-control AlterInput w-100  " placeholder="Primary Email..." readonly value="{{$email}}">
