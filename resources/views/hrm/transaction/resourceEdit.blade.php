                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label class="form-group  p-0   InputLabel w-100 ">
                            <input type="text" name="resourceCode" class="form-control AlterInput w-100 " placeholder="Ex : Something" >
                    ...
                    <div class="form-group col-md-6">
                        <label class="form-group  p-0   InputLabel w-100 m-1">
                            <select class="search-need form-select w-100 AlterInput"  name="resourceTypeId">
                                ...
                                {{-- @foreach($hrmResourceTypeLists as $resource)
                ...
                <div class="col-lg-12 d-flex justify-content-between flex-wrap">
                    ...
                    <div class="col-lg-9">
                                ...
                                <div class="input-group-prepend w-20">
                                    <label class="form-group  p-0   InputLabel w-100 " >
                                        <select class="form-select w-100 " name="salutationId" style="border-top-right-radius:0 !important; border-bottom-right-radius:0 !important;">
                                            ...
                                            <option value="{{$saluation['id']}}">{{$saluation['salutation']}}</option>
                                            @endforeach --}}
                                        </select>
                                    </label>
                                </div>
                                <label class="form-group  p-0   InputLabel w-80 ">
                                    <input type="text" name="firstName" class="form-control AlterInput w-100" placeholder="First Name..." style="border-top-left-radius:0 !important; border-bottom-left-radius:0 !important;">
                                    <span class="AlterInputLabel">First Name <sup>*</sup></span>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-group  p-0   InputLabel w-100 ">
                                    <input type="text" name="middleName" class="form-control AlterInput w-100 " placeholder="Middle Name...">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="form-group  p-0   InputLabel w-100 ">
                                    <input type="text" name="lastName" class="form-control AlterInput w-100 " placeholder="Last Name or Initial...">
                                    <span class="AlterInputLabel">Last Name or Initial</span>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-group  p-0   InputLabel w-100 ">
                                    <input type="text" name="nickName" class="form-control AlterInput w-100 " placeholder="Account Ledger Name...">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="form-group  p-0   InputLabel w-100 ">
                                    <input type="text" placeholder="date" name="dob" validationAttr="date" class="form-control AlterInput w-100 datepicker" placeholder="DOB...">
                                    <span class="AlterInputLabel">DOB <sup>*</sup></span>
                                </label>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-group  p-0   InputLabel w-100 ">
                                    <input type="text" name="birthCity" class="form-control AlterInput w-100  " placeholder="Birth City...">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="form-group  p-0   InputLabel w-100 ">
                                    <select class="form-select w-100 AlterInput" name="maritalStatus">
                                        ...
                                        {{-- @foreach($maritalStatusLists as $maritalStatus)
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-group  p-0   InputLabel w-100 ">
                                    <input type="text" placeholder="Anniversary Date..." validationAttr="date" name="anniversaryDate" class="form-control AlterInput w-100  datepicker" placeholder="Anniversary Date...">
            ...
            <div id="customButtons3">
                <div class="form-row">
                    <div class="form-group col-md-2 ">
                        <label class="form-group  p-0   InputLabel w-100 m-1">
                            <input type="text" name="mobileNumber" class="form-control AlterInput w-100 " placeholder="primary Mobile..." readonly value="">
                ...
                <hr>
                    ...
                    <div class="form-group col-md-2 ">
                        <label class="form-group  p-0   InputLabel w-100 m-1">
                            ...
                            <input type="email" name="email" class="form-control AlterInput w-100  " placeholder="Primary Email..." readonly value="">
                ...
                <div class="col-12 p-0">
                    <div class="form-row  ">
                        ...
                        <div class="form-group col-md-2 m-1">
                            <label class="form-group  p-0   InputLabel w-100 m-1">
                                <input type="text" name="doorNo[]" class="form-control AlterInput w-100  todoRequired" placeholder="Door No...">
                                <span class="AlterInputLabel">Door No </span>
                            </label>
                        </div>
                        <div class="form-group col-md-2 m-1">
                            <label class="form-group  p-0   InputLabel w-100 m-1">
                                <input type="text" name="buildingName[]" class="form-control AlterInput w-100  " placeholder="Building Name...">
                        ...
                        <div class="form-group col-md-2 m-1">
                            <label class="form-group  p-0   InputLabel w-100 m-1">
                                <input type="text" name="street[]" class="form-control AlterInput w-100  " placeholder="Street...">
                        ...
                        <div class="form-group col-md-2 m-1">
                            <label class="form-group  p-0   InputLabel w-100 m-1">
                                <input type="text" name="landMark[]" class="form-control AlterInput w-100  " placeholder="Land Mark...">
                    ...
                    <div class="form-row  ">
                        <div class="form-group col-md-2 ">
                            <label class="form-group  p-0   InputLabel w-100 m-1">
                                <input type="text" name="pinCode[]" class="form-control AlterInput w-100  todoRequired" placeholder="Pin code...">
                        ...
                        <div class="form-group col-md-2 m-1">
                            <label class="form-group  p-0   InputLabel w-100 m-1">
                                <input type="text" name="state[]" class="form-control AlterInput w-100  " placeholder="State...">
                                <span class="AlterInputLabel">State</span>
                            </label>
                        </div>
                        <div class="form-group col-md-2 m-1">
                            <label class="form-group  p-0   InputLabel w-100 m-1">
                                <input type="text" name="city[]" class="form-control AlterInput w-100  " placeholder="City...">
                                <span class="AlterInputLabel">City</span>
                            </label>
                        </div>
                        <div class="form-group col-md-2 m-1">
                            <label class="form-group  p-0   InputLabel w-100 m-1">
                                <input type="text" name="district[]" class="form-control AlterInput w-100  " placeholder="District...">
                                <span class="AlterInputLabel">District</span>
                            </label>
                        </div>
                        <div class="form-group col-md-2 m-1">
                            <label class="form-group  p-0   InputLabel w-100 m-1">
                                <input type="text" name="area[]" class="form-control AlterInput w-100  " placeholder="Area...">
