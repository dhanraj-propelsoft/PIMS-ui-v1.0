...
<form action="/add-resource-stage-3" class="col-sm-6 card m-auto p-5">
    <div class="form-check p-2 m-2">
        <label class="form-check-label w-100" for="gridCheck1" class="col-10">
            {{-- You confirm to cancel the Relive option and continue the resource with existing resource code, with his  own Book of Record, with all his existing credentials and user data. --}}
            Cancel the Relive option was reversed successfully
