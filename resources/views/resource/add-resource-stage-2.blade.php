...
{{-- This is For Navigation and Breadcrumbs --}}
 ...
 <!-- | -->   </div>                                                 <!-- | -->
   ...
   <div >
    <p>
        This Mobile Number 9090909090 and email valla@gmail.com has thes recordon our system By selecting one of them you ensure its your record.
    </p>
    <hr>
...
.RadioGroup input {
  ...
  visibility: hidden;
    ...
    <div class="col-12 d-flex justify-content-center mt-5">
        <button type="submit" class="propelbtn propelcurved propelsubmit ">Continue</button>
      </div>
   </div>
</form>
