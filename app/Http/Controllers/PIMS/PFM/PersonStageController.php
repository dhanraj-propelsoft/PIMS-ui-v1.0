...
class PersonStageController extends Controller
{
    ...
    {
        return view('pimsUi/pfm/personStage/add');
    }
    ...
    public function show($id)
    {
        ...
        if ($response->status() == 200) {
            ...
            return view('pimsUi/pfm/personStage/view', compact('modeldata'));
        } else {
            dd("un authendicated");
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($response->status() == 200) {
            ...
            return view('pimsUi/pfm/personStage/edit', compact('modeldata'));
        } else {
            dd("un authendicated");
        }
    }
